...
@section('content')
    <form action="{{ route('circles.update',$sekolah->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            {{-- <tr>
                                <td colspan="3">
                                    ...
                                    <a href="{{ route('circles.index') }}" class="btn btn-default">Batal</a>
                                </td>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <a href="{{ route('circles.index') }}" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
