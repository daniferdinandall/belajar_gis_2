...
@section('content')
    <form action="{{ route('polyline.update',$sekolah->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            {{-- <tr>
                                <td colspan="3">
                                    ...
                                    <a href="{{ route('polyline.index') }}" class="btn btn-default">Batal</a>
                                </td>
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">Simpan</button>
                            <button type="button" class="btn btn-warning" id="clearPolyline">Bersihkan Polyline</button>
                            <a href="{{ route('polyline.index') }}" class="btn btn-danger">Batal</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('js')
    <script>
        ...
        //
        var clearPolyline = document.getElementById('clearPolyline');
        ...
        clearPolyline.addEventListener('click', function() {
