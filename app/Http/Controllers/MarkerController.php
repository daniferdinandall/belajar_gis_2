...
class MarkerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('markers.index')->with('success', 'Data Sekolah Berhasil Ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('markers.index')->with('success', 'Data sekolah berhasil diupdate.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('markers.index')->with('success', 'Data sekolah berhasil dihapus.');
    }
}
